    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(blank=True, max_length=180, verbose_name='full name')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='email')),
                ('user_type', models.CharField(blank=True, choices=[('ADMIN', 'admin'), ('NORMAL', 'normal')], default='NORMAL', max_length=20, verbose_name='user type')),
                ...
                ('contact_no', models.CharField(blank=True, max_length=20, null=True, verbose_name='contact no')),
                ('_profile_photo', models.ImageField(blank=True, null=True, upload_to='profile_photo')),
